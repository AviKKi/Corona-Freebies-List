...
export default ({data: {allMdx:post,file:bannerimg}}) => {
    ...
    return <>
        <Layout width={1500}>
        <SEO title="Home" description="List of Freebeis due to corona pandemic" />
        <Banner>
            <Img alt="" fluid={bannerimg.childImageSharp.fluid} style={{maxWidth:'500px',width:'100%'}} />
            <div>
            <h1 style={{marginTop:'10px',textAlign:'center'}}>Corona Freebeis</h1>
            <p>One Place to look for all the freebies available when you are locked down.</p>
            </div>
        </Banner>
